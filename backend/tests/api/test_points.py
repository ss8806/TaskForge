...
from app.models import User, Achievement, PointsHistory, UserAchievement
...
def achievements(session: Session):
    """実績のフィクスチャ。"""
    achievements_data = [
        {"key": "first_commit", "title": "初回コミット", "description": "最初のコミット", "points": 100},
        {"key": "bug_hunter", "title": "バグハンター", "description": "バグを修正", "points": 50},
        {"key": "repo_cleaner", "title": "レポクリーナー", "description": "リポジトリを整理", "points": 30},
    ]
