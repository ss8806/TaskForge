    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 p-4">
      ...
      <Card className="w-full max-w-md bg-zinc-900/50 border-zinc-800 backdrop-blur-xl">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight text-zinc-100">アカウント作成</CardTitle>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                {...form.register('email')}
                className="bg-zinc-800/50 border-zinc-700 text-zinc-100 placeholder:text-zinc-600 focus:ring-zinc-600"
              />
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <div className="text-center text-sm text-zinc-500">
              すでにアカウントをお持ちですか？{' '}
              <Link href="/login" className="text-zinc-300 hover:text-zinc-100 transition-colors underline-offset-4 hover:underline">
                ログイン
              </Link>
            </div>
          </CardFooter>
